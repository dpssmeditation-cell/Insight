    ...
    <header className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 sticky top-0 z-50 transition-all duration-300">
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="flex justify-between items-center h-20">
          ...
          >
            <div className="bg-amber-900 text-white w-10 h-10 flex items-center justify-center font-serif font-bold text-lg rounded-sm transition-transform group-hover:scale-105">
              IS
            </div>
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            {navItems.map((item, idx) => (
              <button
                ...
                className={`text-[14px] font-medium transition-all duration-200 border-b-2 border-transparent py-1 ${
          ...
          <nav className="flex flex-col p-6 space-y-4">
             {navItems.map((item, idx) => (
              <button
                ...
                className={`text-lg font-serif font-medium text-left border-l-4 pl-3 transition-all ${
                     (currentView === item.view)
                     ? 'text-amber-900 dark:text-amber-500 border-amber-900 dark:border-amber-500'
